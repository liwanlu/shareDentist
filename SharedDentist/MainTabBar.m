...
//         NSLog(NSStringFromCGRect(tabBarBtn.frame));
        //只有执行layoutSubviews后，frame才会被负值，所以这时调用这个方法，把红点view生成了。在其他真正需要的地方再负值
        [tabBarBtn createBadgeValueView];
    }
}
...
//    }
//}
-(void)setBadgeValue:(NSString *)value andIndex:(int)index
{
    MainTabBarButton *btn=self.tabbarBtnArray[index];
